            ...
            switch (rom_error) {
                ...
                case recomp::RomValidationError::IncorrectVersion:
                    recompui::message_box(
                            "This ROM is Diddy Kong Racing, but it is the wrong version.\nThis build requires the unmodified USA (En,Fr) Rev 1 ROM.");
                    break;
...
void select_rom() {
    recompui::open_info_prompt("Recomp Setup",
        "Welcome to Diddy Kong Racing: Recompiled!\n\n"
            "Choose your legally obtained, unmodified Diddy Kong Racing USA (En,Fr) Rev 1 ROM. "
            "The ROM stays on your Mac and is never bundled into the application.",
        "Select ROM",
...
void start_game_preflight() {
    dino::renderer::preload_common_shaders();
    start_game();
}
